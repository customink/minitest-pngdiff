...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Minitest matchers for comparing PNG images}
  spec.description   = %q{This gem provides minitest matches that allows comparing PNG images for similarity}
